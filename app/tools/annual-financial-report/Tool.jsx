...
function LiveDemoModal({ open, onClose }) {
  ...
  if (!open) return null
  return (
    <div role="dialog" aria-modal="true" aria-label="Live Annual Financial Report"
      onClick={onClose}
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1240px] px-6 py-20 md:py-28">
          <nav aria-label="Breadcrumb" className="mb-10 flex flex-wrap items-center gap-2 font-mono text-[11px] uppercase tracking-[0.12em] text-ink-500">
            ...
            <span className="text-ink-400">/</span>
            <span className="text-ink-950">Annual Financial Report</span>
          </nav>
          ...
          <p className="mb-10 max-w-[640px] text-xl leading-[1.55] text-ink-700">
            Year-end financial reports for shareholders, the board, or HMRC / IRS filings. Branded cover page, headline cards, KPI table with Δ vs prior year and target, revenue and expense breakdowns, chairman&rsquo;s letter, commentary, risks, outlook, and a signed sign-off — in one auto-formatted PDF.
          </p>
...
export default function AnnualFinancialReportTool() {
  return (
    <>
      <ToolHero />
      <PreviewSection />
