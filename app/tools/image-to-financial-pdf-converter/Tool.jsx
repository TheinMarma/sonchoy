...
function LiveDemoModal({ open, onClose }) {
  ...
  if (!open) return null
  return (
    <div role="dialog" aria-modal="true" aria-label="Image to Financial PDF Converter"
      onClick={onClose}
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1240px] px-6 py-20 md:py-28">
          <nav aria-label="Breadcrumb" className="mb-10 flex flex-wrap items-center gap-2 font-mono text-[11px] uppercase tracking-[0.12em] text-ink-500">
            ...
            <span className="text-ink-400">/</span>
            <span className="text-ink-950">Image to Financial PDF Converter</span>
          </nav>
          <span className="mb-7 inline-flex items-center gap-2.5 rounded-full border border-convert/30 bg-convert-bg px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.14em] text-convert">
            ...
            Convert · Financial images to PDF
          </span>
          ...
          <p className="mb-10 max-w-[640px] text-xl leading-[1.55] text-ink-700">
            Drag in every JPG or PNG of invoices, receipts, cheques, statements, or any other financial paperwork. The tool stitches them into a single ordered, archive-grade PDF — A4, Letter, or a narrow strip — with optional cover sheet and captions.
          </p>
...
export default function ImageToFinancialPdfConverterTool() {
  return (
    <>
      <ToolHero />
      <PreviewSection />
