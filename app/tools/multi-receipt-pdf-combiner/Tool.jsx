...
function LiveDemoModal({ open, onClose }) {
  ...
  if (!open) return null
  return (
    <div role="dialog" aria-modal="true" aria-label="Multi Receipt PDF Combiner"
      onClick={onClose}
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1240px] px-6 py-20 md:py-28">
          <nav aria-label="Breadcrumb" className="mb-10 flex flex-wrap items-center gap-2 font-mono text-[11px] uppercase tracking-[0.12em] text-ink-500">
            ...
            <span className="text-ink-400">/</span>
            <span className="text-ink-950">Multi Receipt PDF Combiner</span>
          </nav>
          ...
          <p className="mb-10 max-w-[640px] text-xl leading-[1.55] text-ink-700">
            Combine dozens of receipt PDFs into a single expense-ready packet. Drag in any number of files, reorder, optionally add a branded cover sheet with a table of contents, and download.
          </p>
...
export default function MultiReceiptPdfCombinerTool() {
  return (
    <>
      <ToolHero />
      <PreviewSection />
