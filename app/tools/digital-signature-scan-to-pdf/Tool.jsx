...
function LiveDemoModal({ open, onClose }) {
  ...
  if (!open) return null
  return (
    <div role="dialog" aria-modal="true" aria-label="Digital Signature Scan to PDF"
      onClick={onClose}
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1240px] px-6 py-20 md:py-28">
          <nav aria-label="Breadcrumb" className="mb-10 flex flex-wrap items-center gap-2 font-mono text-[11px] uppercase tracking-[0.12em] text-ink-500">
            ...
            <span className="text-ink-400">/</span>
            <span className="text-ink-950">Digital Signature Scan to PDF</span>
          </nav>
          ...
          <p className="mb-10 max-w-[640px] text-xl leading-[1.55] text-ink-700">
            Upload a scan or photo of your wet signature — JPG, PNG, or a phone snap — and embed it cleanly into any PDF. Drop it on the last page (or any page) at any position. Output is a signed PDF; the original stays untouched.
          </p>
...
export default function DigitalSignatureScanToPdfTool() {
  return (
    <>
      <ToolHero />
      <PreviewSection />
