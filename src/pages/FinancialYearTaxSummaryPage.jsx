...
function LiveDemoModal({ open, onClose }) {
  ...
  if (!open) return null
  return (
    <div role="dialog" aria-modal="true" aria-label="Live Financial Year Tax Summary"
      onClick={onClose}
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1240px] px-6 py-20 md:py-28">
          <nav aria-label="Breadcrumb" className="mb-10 flex flex-wrap items-center gap-2 font-mono text-[11px] uppercase tracking-[0.12em] text-ink-500">
            ...
            <span className="text-ink-400">/</span>
            <span className="text-ink-950">Financial Year Tax Summary</span>
          </nav>
          ...
          <p className="mb-10 max-w-[640px] text-xl leading-[1.55] text-ink-700">
            A year-end overview of every tax line — income tax, GST / VAT, sales tax, payroll, TDS, property — with totals collected, remitted, refunded, and still owed. Auto-derived status, overdue items in red, ready for accountant hand-off or self-assessment filing.
          </p>
...
export default function FinancialYearTaxSummaryPage() {
  return (
    <>
      <ToolHero />
      <PreviewSection />
