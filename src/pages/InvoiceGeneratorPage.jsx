    ...
    <header className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1240px] px-6 pb-16 pt-12 md:pt-16">
        ...
        <div className="grid grid-cols-1 items-start gap-12 md:grid-cols-[1.05fr_1fr] md:gap-16">
          {/* Left — copy */}
          <div>
            <div className="mb-6 inline-flex items-center gap-2.5 rounded-full border border-invoicing/30 bg-invoicing-bg px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.14em] text-invoicing">
              <span className="h-1.5 w-1.5 rounded-full bg-invoicing" />
            ...
            <h1 className="mb-5 text-4xl font-medium leading-[1.04] tracking-[-0.03em] text-ink-950 md:text-[56px] md:leading-[1.02]">
              Invoice generator{' '}
              <em className="font-serif font-normal italic text-crimson-300">built for</em>
              {' '}finance teams.
            </h1>
            ...
            <ul className="m-0 mb-8 grid list-none grid-cols-1 gap-2 p-0 sm:grid-cols-2">
              {[
                ...
                'GST / VAT / Sales tax presets',
                'Multi-currency & locale-aware',
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 font-mono text-[11px] uppercase tracking-[0.08em] text-ink-500">
              ...
              <span className="inline-flex items-center gap-1.5">
                <Check size={12} className="text-crimson-400" /> Print-ready output
              </span>
              <span className="inline-flex items-center gap-1.5">
                <Check size={12} className="text-crimson-400" /> Reusable templates
              </span>
            </div>
          </div>

          {/* Right — generator panel mockup */}
          <GeneratorPanel />
        </div>
      </div>
    </header>
