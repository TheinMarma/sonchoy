...
export default function NotFoundPage() {
  ...
  /* Set a real 404 status when prerendered / scraped via meta tag.
     Browsers will still render the page; this is for crawlers. */
  useEffect(() => {
    document.title = '404 · Page not found — Sonchoy'
  ...
  const submitSearch = (e) => {
    ...
    navigate(`/#tools?q=${encodeURIComponent(value)}`)
  }
    ...
    <main className="relative min-h-[calc(100vh-72px)] overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1240px] px-6 py-20 md:py-28">
        ...
        <div className="mb-14 flex flex-wrap items-center gap-3">
          <Link to="/" className="btn btn-cta btn-xl">
