...
const TOOLS = [
  ...
  { group: 'conversion', cat: 'convert', name: 'PDF to Excel',                      desc: 'Convert any PDF table into a fully editable Excel workbook.', Icon: PdfToExcelIcon },
  { group: 'conversion', cat: 'convert', name: 'JPG Receipt to PDF',                desc: 'Single receipt photos into print-ready PDFs for expense filing.', Icon: ImageToPdfIcon },
  { group: 'conversion', cat: 'convert', name: 'Scan to PDF',                       desc: 'Stitch scanned pages into one searchable PDF with auto-deskew.', Icon: ScanIcon },
  { group: 'conversion', cat: 'convert', name: 'PDF to XLSX Converter',             desc: 'Direct PDF → XLSX with formula-aware columns and merged-cell handling.', Icon: PdfToExcelIcon },
  { group: 'conversion', cat: 'convert', name: 'CSV to PDF Converter',              desc: 'Convert CSV files into branded, print-ready PDFs with auto-formatting.', Icon: ExcelToPdfIcon },
  { group: 'conversion', cat: 'convert', name: 'Financial Report PDF to Excel',     desc: 'Pull P&L, balance sheet, and cash-flow tables out of any report PDF.', Icon: ReportIcon },
  { group: 'conversion', cat: 'convert', name: 'OCR Receipt to Text',               desc: 'Read printed and handwritten receipts into searchable text and JSON.', Icon: OcrIcon, featured: true },
  { group: 'conversion', cat: 'convert', name: 'OCR Invoice to Excel',              desc: 'Optical character recognition for invoices — every field structured into Excel.', Icon: OcrIcon },
  { group: 'conversion', cat: 'convert', name: 'PNG Receipt to PDF',                desc: 'High-quality PNG receipts compiled into archive-ready PDFs.', Icon: ImageToPdfIcon },
  ...
  { group: 'accounting', cat: 'business', name: 'Business Expense Breakdown',      desc: 'Expenses by category with percentage splits and month-over-month trend.', Icon: BudgetIcon },
  { group: 'accounting', cat: 'business', name: 'Payroll Summary Generator',       desc: 'Wages, deductions, and employer taxes — period-by-period.', Icon: PayrollIcon },
  { group: 'accounting', cat: 'business', name: 'Tax Summary Report',              desc: 'Tax collected, owed, and remitted across periods and regions.', Icon: PercentIcon },
